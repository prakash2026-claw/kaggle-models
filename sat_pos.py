...
with st.form("prediction_form"):
    ...
    with col1:
        ...
        Altitude = st.number_input("Altitude", min_value=-1, value=-28.0)
        Fuel_Level = st.number_input("Fuel_Level", min_value=-1, value=-20.15839350086838)
    ...
    with col2:        
        ...
        Solar_Exposure = st.number_input("Solar_Exposure", min_value=-1, value=-5.760837892713907)
